...
namespace Win.Hotel
{
    public partial class FormFactura : Form
    {
        ...
        public FormFactura()
        {
            ...
            listaClientesBindingSource.DataSource = _habitacionBL.ObtenerHabitaciones();
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            if (idTextBox.Text != " ")
            {
                var resultado = MessageBox.Show("Desea anular este factura?", "Anular", MessageBoxButtons.YesNo);
